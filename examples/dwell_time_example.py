#
# dwell_time_example.py: Dwell Time Analytics Example
#
# Copyright DeGirum Corporation 2025
# All rights reserved
#
# Demonstrates dwell time analytics by tracking how long people spend in zones
# using DeGirum Retail SDK.
#
# You can configure all the settings in the `dwell_time_config.yaml` file.
#
...
def main():
    ...
    config_file = Path(__file__).parent / "dwell_time_config.yaml"
    ...
    print("=" * 60)
    print("Dwell Time Analytics Example")
    print("=" * 60)
    ...
    composition = tracker.start_tracking_pipeline(
        ...
        window_title="Dwell Time Analytics"
    )
