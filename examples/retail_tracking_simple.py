#
# retail_tracking_simple.py: Simple Retail Tracking Example
#
# Copyright DeGirum Corporation 2025
# All rights reserved
#
# Implements a simple retail tracking example using DeGirum Retail SDK.
# This example demonstrates how to set up a retail analytics pipeline and run it on video.
#
# You can configure all the settings in the `retail_config.yaml` file.
#
...
def main():
    ...
    config_file = Path(__file__).parent / "retail_config.yaml"
    ...
    print("=" * 60)
    print("Simple Retail Tracking Example")
    print("=" * 60)
    ...
    composition = tracker.start_tracking_pipeline(
        ...
        window_title="Retail Analytics - Simple Example"
    )
