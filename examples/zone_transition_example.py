#
# zone_transition_example.py: Zone Transition Analytics Example
#
# Copyright DeGirum Corporation 2025
# All rights reserved
#
# Demonstrates zone transition analytics by tracking people moving between
# zones (e.g. entrance -> waiting -> service) using DeGirum Retail SDK.
#
# You can configure all the settings in the `zone_transition_config.yaml` file.
#
...
def main():
    ...
    config_file = Path(__file__).parent / "zone_transition_config.yaml"
    ...
    print("=" * 60)
    print("Zone Transition Analytics Example")
    print("=" * 60)
    ...
    composition = tracker.start_tracking_pipeline(
        ...
        window_title="Zone Transition Analytics"
    )
