#
# gizmo_pipeline_example.py: Gizmo Pipeline Example with Zone Density Analytics
#
# Copyright DeGirum Corporation 2025
# All rights reserved
#
# Demonstrates zone density analytics using the DeGirum Retail SDK.
# This example uses the same pipeline as retail_tracking_simple.py but with
# a different zone configuration.
#
# You can configure all the settings in the `gizmo_pipeline_config.yaml` file.
#
...
def main():
    ...
    config_file = Path(__file__).parent / "gizmo_pipeline_config.yaml"
    ...
    print("=" * 60)
    print("Gizmo Pipeline Example with Zone Density Analytics")
    print("=" * 60)
